...
def main():
    ...
    module = AnsibleModule(argument_spec=argument_spec, mutually_exclusive=(("positional_args", "named_args"),))
    ...
    kw = {"changed": changed, "executed_queries": executed_queries, "query_result": query_result, "rowcount": rowcount}
